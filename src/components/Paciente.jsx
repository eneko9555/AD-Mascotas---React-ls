    ...
    return (
        ...
        <div className="bg-gray-400 text-white p-3 w-full rounded-md shadow-gray-800 shadow-lg hover:scale-105 ease-in duration-300 transition-all mb-10 ">
            ...
            <div className="flex flex-row justify-around mt-5 gap-5">
                ...
                <button className=" p-2  bg-green-600 rounded-md shadow-md w-1/2 hover:shadow-2xl hover:-translate-y-2
                                    transition-all"
                        onClick={() => setPaciente(paciente)}
                >Editar</button>

                <button className=" p-2 bg-red-600 rounded-md shadow-md w-1/2 hover:shadow-2xl hover:-translate-y-2
                                    transition-all"
